...
from app.infrastructure.dto.driver_assignment_dto import DriverAssignmentRequestDTO, RouteFieldsDTO
...
async def update_driver_assignment(driver_id: int, vehicle_id: int, travel_date: date, assignment_updates: RouteFieldsDTO):
    try:
