...
class DriverAssignment(SQLModel, table=True):
    ...
    origin_location_longitude: Decimal = Field(default=0,max_digits=9, decimal_places=6)
    destination_location_latitude: Decimal = Field(default=0, max_digits=9, decimal_places=6)
    destination_location_longitude: Decimal = Field(default=0, max_digits=9, decimal_places=6)
